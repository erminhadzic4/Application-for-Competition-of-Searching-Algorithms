...
namespace Testovi
{
    ...
    public class Testovi_KlasaMain
    {
        ...
        {
            var odgovor = TakmicenjeAlgoritama.main.ListingKomparacije(1, 100, true);
        ...
        public void TestKlaseMain_IzvrsiPretrage()
        {
            ...
            lista.Add(TakmicenjeAlgoritama.main.IzvrsiPretragu(Pretrage.iscrpnaPretraga<int>, 1, 1000000, 500000, "Iscrpna pretraga", true));
            lista.Add(TakmicenjeAlgoritama.main.IzvrsiPretragu(Pretrage.fibonaciPretraga<int>, 1, 1000000, 500000, "Fibonacci pretraga", true));
            lista.Add(TakmicenjeAlgoritama.main.IzvrsiPretragu(Pretrage.binarnaPretraga<int>, 1, 1000000, 500000, "Binarna pretraga", true));
            lista.Add(TakmicenjeAlgoritama.main.IzvrsiPretragu(Pretrage.skokPretraga<int>, 1, 1000000, 500000, "Skok pretraga", true));
            lista.Add(TakmicenjeAlgoritama.main.IzvrsiPretragu(Pretrage.eksponencijalnaPretraga<int>, 1, 1000000, 500000, "Eksponencijalna pretraga", true));
            lista.Add(TakmicenjeAlgoritama.main.IzvrsiPretragu(Pretrage.rekurzivnaBinarnaPretraga<int>, 1, 1000000, 500000, "Rekurzivna binarna pretraga", true));
        ...
        {
            var lista = TakmicenjeAlgoritama.main.ListingKomparacijeOsoba(10000);
            Assert.IsNotNull(lista);
        }
        ...
        {
            var osobe = TakmicenjeAlgoritama.main.DajListuOsoba(100);
        ...
        {
            var niz = TakmicenjeAlgoritama.main.DajNiz(1, 100);
        ...
        {
            var list = TakmicenjeAlgoritama.main.DajListu(1, 100);
        ...
        {
            var odgovor = TakmicenjeAlgoritama.main.ZapocniKomparaciju(1, 100000, 50000, true);
            TakmicenjeAlgoritama.main.ZapocniKomparaciju(1, 100000, 50000, false);
        ...
        {
            var osobe = TakmicenjeAlgoritama.main.DajListuOsoba(100);
            var odgovor = TakmicenjeAlgoritama.main.IzvrsiPretraguOsoba(Pretrage.iscrpnaPretraga<Osoba>, osobe, 100, osobe[40], "Iscrpna pretraga");
        ...
        {
            var osobe = TakmicenjeAlgoritama.main.DajListuOsoba(100);
            var odgovor = TakmicenjeAlgoritama.main.ZapocniKomparacijuOsoba(osobe, 100, osobe[40]);
